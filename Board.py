        ...
        if len(possibleJumps) == 0:
            ...
            while len(possibleJumps) > 0:
                ...
                if (x_spotReached, y_spotReached) not in path and (x_spotReached, y_spotReached) != key \
                    ...
                    self._addJumpMoves((x_spotReached, y_spotReached), path, self._possibleJumpSpots(
                        (x_spotReached, y_spotReached)))  # check if there are any jumps you can make from there
